...
class SaaSAPI:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype fulfillment_operations: azure.marketplace.operations.FulfillmentOperationsOperations
    :ivar subscription_operations: SubscriptionOperationsOperations operations
    :vartype subscription_operations: azure.marketplace.operations.SubscriptionOperationsOperations
