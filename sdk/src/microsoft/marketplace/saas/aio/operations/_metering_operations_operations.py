...
class MeteringOperationsOperations:
    ...
    async def post_usage_event(
        ...
        **kwargs
        ...
        :param body:
        :type body: ~microsoft.marketplace.saas.models.UsageEvent
        ...
        :rtype: ~microsoft.marketplace.saas.models.UsageEventOkResponse or None
    ...
    async def post_batch_usage_event(
        ...
        **kwargs
        ...
        :param body:
        :type body: list[~microsoft.marketplace.saas.models.UsageEvent]
        :param request_id_parameter: A unique string value for tracking the request from the client,
         preferably a GUID. If this value isn't provided, one will be generated and provided in the
         response headers.
        :type request_id_parameter: str
        ...
        :rtype: list[~microsoft.marketplace.saas.models.UsageEventOkResponse] or None
        :raises: ~azure.core.exceptions.HttpResponseError
        """
